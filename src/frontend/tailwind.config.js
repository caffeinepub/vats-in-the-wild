    ...
    extend: {
      ...
      keyframes: {
        ...
        kenBurns: {
          ...
          "66%":  { transform: "scale(1.10) translate(0.8%, 0.8%)" },
        ...
        mistyDrift: {
          ...
          "50%":  { transform: "translateX(-1.5%) scale(1.07)" },
      ...
      animation: {
        ...
        "breathe-overlay": "breatheOverlay 8s ease-in-out infinite",
        "misty-drift": "mistyDrift 20s ease-in-out infinite",
      },
    },
  },
